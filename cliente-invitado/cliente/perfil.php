  ...
  <aside id="sidebar" class="bg-gradient-to-b from-sky-900 via-cyan-800 to-teal-700 text-white flex flex-col justify-between shadow-2xl w-20">
    <div>
      ...
      <div id="toggleBtn" class="flex items-center gap-4 px-6 py-5 border-b border-cyan-600 cursor-pointer hover:bg-cyan-900 transition-all duration-300">
        ...
        <h1 id="sidebar-title" class="text-xl font-semibold tracking-wide select-none hidden">Panel Cliente</h1>
      </div>

      <!-- Navegación -->
      <nav class="mt-8 space-y-3">
        <div class="relative group">
          <a href="cliente.php" class="flex items-center gap-3 px-6 py-3 hover:bg-teal-800 rounded-lg transition">
        ...
        <div class="relative group">
          <a href="destinos.php" class="flex items-center gap-3 px-6 py-3 hover:bg-teal-800 rounded-lg transition">
        ...
        <div class="relative group">
          <a href="mis_reservas.php" class="flex items-center gap-3 px-6 py-3 hover:bg-teal-800 rounded-lg transition">
